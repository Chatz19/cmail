	...
	<body id = "body">
		...
		<aside id = "aside">
			...
			<section>
				...
				<a href="unblock.php" class = "active">Blocked</a>
		...
		<article id = "article">
			<section>
				<table>
					...
					<?php 
					$sql = "SELECT * FROM user WHERE cmail != '$cmail' AND blocked = 1";
					...
					<tr>
						...
						<td onclick = "location.assign('http:decide.php?user=<?php echo $h['cmail']; ?>&block=0')">Unblock</td>
					</tr>
					<?php } ?>
				</table>
			</section>
