...
<html>
	<head>
		...
		.inbox div div span{font-weight: bold; margin-right: 4px;}
		.inbox img{height: 30px; width: 30px; object-fit: cover; border-radius: 100%; vertical-align: middle; cursor: pointer;}
	...
	<body id = "body">
		...
		<aside id = "aside">
			...
			<section>
				...
				<a href="sent.php" class = "active">Sent</a>
		...
		<article id = "article">
			...
			<section>
				...
				<div class = "profile" id = "hideProfile">
					...
					<form action = "forward.php" style = "display:inline-block">
						<input type = "hidden" name = "id" id = "forward">
					<button>Forward</button>
					</form>
					<img src="../image/<?php echo $r['image']; ?>" class = "profileImage">
				</div>
				<?php 
					$sql = "SELECT * FROM compose WHERE sender = '$cmail' ORDER BY message_ID DESC";
					$result = mysqli_query($connection, $sql);
